...
subgraph Discovery
    A[<a href='https://github.com/valuedriven/sewai/blob/main/docs/fluxo/roteiro_discovery.md'>Roteiro</a>]
end

subgraph Delivery
    B[<a href='https://github.com/valuedriven/sewai/blob/main/docs/fluxo/roteiro_delivery.md'>Roteiro</a>]
end
